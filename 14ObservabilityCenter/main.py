...
# -*- coding: utf-8 -*-
"""
模组14: ObservabilityCenter - 可观测性中心 - 提供系统监控、日志聚合、性能分析和告警管理
...
# FastAPI应用实例
app = FastAPI(
    title="模组14: ObservabilityCenter",
    description="可观测性中心 - 提供系统监控、日志聚合、性能分析和告警管理",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
...
async def health_check(request: Request):
    ...
    return HealthResponse(
        ...
        module="模组14: ObservabilityCenter",
        version="1.0.0"
    )

@app.get("/live")
async def live():
    """存活探针（liveness）- 轻量快速返回服务是否存活"""
    return {
        "status": "ok",
...
async def root():
    """根路径"""
    return {
        "message": "Welcome to 模组14: ObservabilityCenter",
        "description": "可观测性中心 - 提供系统监控、日志聚合、性能分析和告警管理",
        "docs": "/docs",
        "health": "/health"
    }
...
async def process_zmq_message(message: Dict) -> Dict:
    ...
    try:
        ...
        return {
            ...
            "data": message,
            "timestamp": datetime.now().isoformat(),
            "processed_by": "模组14: ObservabilityCenter"
        }
    except Exception as e:
        return {
            "success": False,
...
async def startup_event():
    """应用启动事件"""
    logger.info(f"模组14: ObservabilityCenter starting up...")
    ...
    logger.info(f"模组14: ObservabilityCenter started successfully")

@app.on_event("shutdown")
async def shutdown_event():
    """应用关闭事件"""
    logger.info(f"模组14: ObservabilityCenter shutting down...")
    
    # 清理ZeroMQ资源
    zmq_context.term()
    
    logger.info(f"模组14: ObservabilityCenter shutdown complete")
