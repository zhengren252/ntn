...
# -*- coding: utf-8 -*-
"""
模组11: ASTSConsole - 智能化指挥中心 - 提供智能指挥控制台、实时监控面板和决策支持系统

NeuroTrade Nexus (NTN) AI智能体驱动交易系统
模组编号: 模组11

主要功能:
- 智能化指挥中心 - 提供智能指挥控制台、实时监控面板和决策支持系统
- RESTful API服务
- ZeroMQ消息通信
- Docker容器化部署
"""
...
# FastAPI应用实例
app = FastAPI(
    title="模组11: ASTSConsole",
    description="智能化指挥中心 - 提供智能指挥控制台、实时监控面板和决策支持系统",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
...
async def root():
    """根路径"""
    return {
        "message": "Welcome to 模组11: ASTSConsole",
        "description": "智能化指挥中心 - 提供智能指挥控制台、实时监控面板和决策支持系统",
        "docs": "/docs",
        "health": "/health"
    }
...
async def startup_event():
    """应用启动事件"""
    logger.info(f"模组11: ASTSConsole starting up...")
    ...
    logger.info(f"模组11: ASTSConsole started successfully")

@app.on_event("shutdown")
async def shutdown_event():
    """应用关闭事件"""
    logger.info(f"模组11: ASTSConsole shutting down...")
    
    # 清理ZeroMQ资源
    zmq_context.term()
    
    logger.info(f"模组11: ASTSConsole shutdown complete")
